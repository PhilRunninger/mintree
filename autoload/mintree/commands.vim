...
function! mintree#commands#Setup()   " {{{1
    for mapping in
      \ [
        ...
        \ [ g:MinTreeFindCharNext,    ":call mintree#nav#FindChar('')<CR>" ],
        \ [ g:MinTreeFindCharPrev,    ":call mintree#nav#FindChar('b')<CR>" ],
...
function! mintree#commands#Help()   " {{{1
    for mapping in
      \ [
        ...
        \ [ g:MinTreeFindCharNext,    "Find next node that starts with <char>." ],
        \ [ g:MinTreeFindCharPrev,    "Find previous node that starts with <char>." ],
