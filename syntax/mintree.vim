...
execute 'syntax match MinTreeMetaData #^'.repeat('\d',mintree#metadata#Width()-1).'[01]# conceal containedin=MinTreeFileIsOpen'
execute 'syntax match MinTreeFileIsOpen  #^'.repeat('\d',mintree#metadata#Width()-1).'1.*#hs=s+4 contains=MinTreeMetaData'
